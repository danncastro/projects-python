...
print(f'Retorna o elemento do indice 2 atribuido a função list - [{lista[2]}]')
...
print(f'Retorna o elemento do indice 0 atribuido a função list, ou seja o primeiro elemento - [{lista[0]}]')
print(f'Retorna o elemento do indice 4 atribuido a função list, ou seja o último elemento - [{lista[4]}]') 
...
print(f'Retorna o elemento de indice -5 equivalente ao primeiro indice da lista, pois começado em -1 de trás para frente temos 5 elementos - [{lista[-5]}]')
